...
best_model = GradientBoostingRegressor(**results['GradientBoosting']['best_params'], random_state=42)
...
y_pred_orig = np.expm1(best_model.predict(X_test_scaled))

print('\nметрики в исходной шкале (CC50, mM)')
