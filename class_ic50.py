...
best_models = {
    'LogisticRegression': LogisticRegression(**results['LogisticRegression']['best_params'], max_iter=5000, random_state=42),
    ...
    'SVC': SVC(**results['SVC']['best_params'], probability=True, random_state=42)
}
