...
gb_best = GradientBoostingRegressor(n_estimators=200, max_depth=3, learning_rate=0.05, random_state=42)
...
y_pred_orig = np.expm1(gb_best.predict(X_test_scaled))

print('\nметрики в исходной шкале (IC50, mM)')
